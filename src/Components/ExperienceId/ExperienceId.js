              ...
              <form className='my-form'>
                <div class='inp-co-1'>
                  ...
                  <div class='inp-co-user'>
                    <button class='modal-select-btn res'>Volunteer Work</button>
                    <button class='modal-select-normal res'>Achievement</button>
                    <button class='modal-select-normal res'>Other</button>
                  </div>
                </div>
                <div class='two'>
                  <div class='inp-co'>
